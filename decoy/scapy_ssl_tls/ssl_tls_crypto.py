...
TLS Session Context:
    ...
    def get_client_ecdh_pubkey(self, private=None):
        ...
        if private is None:
            ...
            import pickle
            client_keypair= pickle.load(open('./clientpriv','r'))
    ...
    #         import pickle
    #         client_keypair= pickle.load(open('/home/hadi/code/clientpriv','r'))
    ...
    def get_client_kex_data(self, val=None):
        ...
        if self.negotiated.key_exchange == tls.TLSKexNames.RSA:
            ...
            raise NotImplementedError("Key exchange unknown or currently not supported: {}".format(self.negotiated.key_exchange))
...
class EAEADCryptoContext(CryptoContext):
    ...
    def encrypt(self, crypto_container):
        ...
        # print("MAC", self.explicit_iv_size, len(mac), mac)
    ...
    def decrypt(self, ciphertext, content_type=tls.TLSContentType.APPLICATION_DATA):
        ...
        # print("DECRYPTING")
        # print("NONCE", explicit_nonce)
        # print("DATA", ciphertext)
        # print("TAG", tag)
        # print("WRITE KEY", self.ctx.sym_keystore.key)
        # print(self.ctx)
        # print(type(self.ctx))
